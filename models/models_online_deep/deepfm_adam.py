...
class DeepFMAdam(nn.Module):
    ...
    def forward(self, Xi, Xv):
        ...
        total_sum = fm_part + torch.sum(x, 1)
        return total_sum
    ...
    def __str__(self):
        return f"DeepFMAdam-Feature_Sizes{self.feature_sizes}-Embedding_Sizes{self.embedding_size}-" \
