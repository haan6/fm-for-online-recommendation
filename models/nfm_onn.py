...
class NFMOnn(nn.Module):
    ...
    def forward(self, Xi, Xv):
        ...
        pred_per_layer.append(torch.sigmoid(fm_first + torch.sum(x, 1)))
    ...
    def __str__(self):
        return f"NFMOnn-Feature_Sizes{self.feature_sizes}-Embedding_Sizes{self.embedding_size}-" \
