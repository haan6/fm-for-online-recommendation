...
if data_config == "Iteration":
    ...
    batch_train_Xi_list, batch_train_Xv_list, batch_train_Y_list, ratio_list \
        = data_preprocess.create_dataset('data/criteo/tiny_train_input.csv', 'data/criteo/category_emb.csv', data_config, num_batch, num_batchdata)
...
for ith_model, ith_model_name in zip(model_list, model_name_list):
    with open(save_model + str(ith_model) + '.pickle', 'wb') as f:
