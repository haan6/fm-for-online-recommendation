...
with torch.cuda.device(0):
    ...
    for i, (option_name, model) in enumerate(result['model'].items()):
        ...
        print(f"======Evaluating {option_name} Done. Time Elapsed: {int(result['time_elapsed'][option_name] / 60)}m {result['time_elapsed'][option_name] - 60 * int(result['time_elapsed'][option_name] / 60)}s======")
