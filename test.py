...
with torch.cuda.device(0):
    ...
    fm = FM(8, train_dict['feature_sizes'], batch_size=20)
    sgd_nfm = SGD_NFM(8, train_dict['feature_sizes'], 5, 10, batch_size=20)
    onn_nfm = ONN_NFM(8, train_dict['feature_sizes'], max_num_hidden_layers=5, qtd_neuron_per_hidden_layer=10,
